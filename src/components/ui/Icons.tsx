...
export const DocumentTextIcon = (p: P) => (
  <I {...p}>
...
export const GlobeAltIcon = (p: P) => (
  <I {...p}>
    <path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z" />
    <path d="M12 3c2.25 2.5 3.375 5.5 3.375 9s-1.125 6.5-3.375 9c-2.25-2.5-3.375-5.5-3.375-9S9.75 5.5 12 3ZM3.5 9h17M3.5 15h17" />
  </I>
);

export const InboxIcon = (p: P) => (
  <I {...p}>
    <path d="M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859M5.25 4.5h13.5a1.5 1.5 0 0 1 1.48 1.243l1.5 9A1.5 1.5 0 0 1 20.25 16.5h-16.5a1.5 1.5 0 0 1-1.48-1.757l1.5-9A1.5 1.5 0 0 1 5.25 4.5Z" />
  </I>
);

export const ArrowRightOnRectangleIcon = (p: P) => (
  <I {...p}>
    <path d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M21 12H9m12 0-3.75-3.75M21 12l-3.75 3.75" />
  </I>
);
